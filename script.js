...
{   id: "buku-23",    
        ...
        penerbit: "Penerbit: Penerbit Baca",
        genre: ["Filsafat","Self-Improvement"],
        rating: "⭐ 4.2/5",
...
daftarBuku.forEach(function(buku) {
    const kotakBuku = `
        <div class="kartu-review kartu-khusus-buku ${buku.genre.join(" ").toLowerCase()}">
